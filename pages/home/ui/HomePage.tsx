		...
		<div className="relative h-dvh w-full overflow-hidden">
			<div className="relative max-w-301 h-full m-auto">
				...
				<div className="hidden lg:absolute lg:bottom-0 lg:left-1/2 lg:block lg:-translate-x-1/2">
					...
					<CatPaws className="absolute -bottom-15 -translate-x-1/2 left-1/2" />
					<Image
						src={tableSrc}
						alt="table"
						loading="eager"
					...
					<Computer>
						...
						только набирала обороты, а потом ушёл в мир сложных продуктов. За
						это время собирал лендинги с анимацией и 3D, сервисы бронирования,
						финтех-интерфейсы с большими данными, Chrome-виджеты, мобильные
						приложения и backend. В пикселях, коде и хаосе ищу порядок, смысл и
