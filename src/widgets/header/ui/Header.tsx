    ...
    <header className="mx-auto w-[min(calc(100vw-32px),420px)] pt-5 pb-4">
      <Reveal delay={120} direction="down">
        <nav
          ...
          className="relative isolate flex items-center justify-center gap-4 font-vcr text-[11px]/none text-white uppercase min-[360px]:gap-6 min-[360px]:text-[12px]/none sm:gap-9 sm:text-[13px]/none"
          ref={navRef}
        >
          <span
            aria-hidden="true"
